...
* Use **[group headers]({{site.baseurl}}/components/group_header)** if there are at least 3–4 controls in one of the groups and all groups can be clearly labeled according to their purpose. 
